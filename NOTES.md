...
You are a staff level full stack engineer. Your task is to **re-evaluate and refactor the ns-rewrite repository** according to the coding standards already written in **AGENTS.md**.  
